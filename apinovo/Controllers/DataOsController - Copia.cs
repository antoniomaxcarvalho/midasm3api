    ...
    public class DataOsController : ApiController
    {
        ...
        public IEnumerable<tb_os> GetAllOs(string clientesDoUsuario)
        {
            ...
            using (var dc = new manutEntities())
            {
                ...
                {
                    user = from p in dc.tb_os.Where((a => (a.cancelado != "S" && clientesDoUsuario.Contains(a.siglaCliente)))).OrderByDescending(p => p.autonumero) select p;
                }
                else
                {
                    user = from p in dc.tb_os.Where((a => (a.cancelado != "S"))).OrderByDescending(p => p.autonumero) select p;
                }
                return user.ToList(); ;
            }
        }
        ...
        public tb_os IncluirOs()
        {
            ...
            using (var dc = new manutEntities())
            {
                using (var transaction = dc.Database.BeginTransaction())
                {
                    ...
                    Os.codigoEquipamento = HttpContext.Current.Request.Form["codigoEquipamento"].ToString();
        ...
        public void AtualizarOs()
        {
            ...
            using (var dc = new manutEntities())
            {
                ...
                if (linha != null && linha.cancelado != "S")
                {
                    ...
                    linha.codigoEquipamento = HttpContext.Current.Request.Form["codigoEquipamento"].ToString();
        ...
        public IEnumerable<tb_os_itens> GetAllOsSistemaCompatibildade(Int64 autonumeroCliente, string data1, string data2, Int32 autonumeroSistema)
        {
            ...
            using (var dc = new manutEntities())
            {
                ...
                itensForaDaPlanilha = (from a in dc.tb_os
                                       ...
                                       where a.cancelado != "S" && b.cancelado != "S" && b.autonumeroCliente == autonumeroCliente
        ...
        public IEnumerable<tb_os_itens> GetAllOsSistema(Int64 autonumeroCliente, string data1, string data2, Int32 autonumeroSistema)
        {
            //IQueryable<tb_os_itens> itensForaDaPlanilha;
            ...
            using (var dc = new manutEntities())
            {
                ...
                //itensDaPlanilha = (from a in dc.tb_os
                //                   join b in dc.tb_os_itens on a.autonumero equals b.autonumeroOs
                //                   where a.cancelado != "S" && b.cancelado != "S" && b.autonumeroCliente == autonumeroCliente
                //                     && a.dataTermino >= data11 && a.dataTermino <= data22 &&
                //                     a.nomeStatus == "Fechada" && a.autonumeroSistema == autonumeroSistema && (b.nomeFonte.Contains("MANUT") || b.nomeFonte.Contains("EQUIPE"))
                ...
                //var resposta = itensForaDaPlanilha.Union(itensDaPlanilha);
                ...
                //foreach (var i in resposta)
                //{
                //    if (i.codigoInsumoServico.Trim() == i.codigoPF.Trim())
                //    {
        ...
        public IEnumerable<itensPlanilha> GetAllItensParaOS(Int64 autonumeroCliente, string data1, string data2, Int32 autonumeroSistema, Int32 autonumeroServico)
        {
            ...
            using (var dc = new manutEntities())
            {
                ...
                itensForaDaPlanilha = (from x in (from i in dc.tb_os_itens
                                       ...
                                       select new itensPlanilha
                                       {
                                           ...
                                           totalPF = Math.Round(((decimal)x.totalPF), 2),
                                           total = Math.Round(((decimal)x.total), 2)
                                       }).Distinct();
        ...
        public IEnumerable<itensPlanilha> GetAllItensCodigoOrdemServico(string codigoOrdemServico,Int64 autonumeroCliente)
        {
            ...
            using (var dc = new manutEntities())
            {
                ...
                var user = (from x in (from i in dc.tb_os_itens
                            ...
                            where o.codigoOrdemServico == codigoOrdemServico && o.cancelado != "S" && o.autonumeroCliente == autonumeroCliente
                            select new itensPlanilha
                            {
        ...
        public IEnumerable<resumoPlanilha> GetAllResumoOs(Int64 autonumeroCliente, string data1, string data2)
        {
            ...
            using (var dc = new manutEntities())
            {
                ...
                itensPlanilha = (from i in dc.tb_os_itens
                                 ...
                                 where i.autonumeroCliente == autonumeroCliente && i.cancelado != "S" && p.cancelado != "S" &&
                                 i.autonumeroCliente == p.autonumeroCliente && i.quantidadePF > 0 &&
                                 p.nomeStatus == "Fechada" && p.dataTermino >= data11 && p.dataTermino <= data22
                ...
                var qtdeOS = (from i in dc.tb_os
                              ...
                              where i.autonumeroCliente == autonumeroCliente && i.cancelado != "S" &&
                                    i.nomeStatus == "Fechada" && i.valor > 0 && i.dataTermino >= data11 && i.dataTermino <= data22
                              ...
                              select new resumoPlanilha
                              {
                                  ...
                                  totalPF = Math.Round((decimal)g.Sum(a => a.valor), 2)
                              });
